...
running command...
$ sfdx (--version)
@cgi-fr/salesforce-toolbox/0.1.5 win32-x64 node-v18.12.1
$ sfdx --help [COMMAND]
USAGE
  $ sfdx COMMAND
...
...
_See code: [src/commands/CGI/profiles/initConfig.ts](https://github.com/CGI-Shapsha/Salesforce-Toolbox/blob/v0.1.5/src/commands/CGI/profiles/initConfig.ts)_
...
_See code: [src/commands/CGI/profiles/update.ts](https://github.com/CGI-Shapsha/Salesforce-Toolbox/blob/v0.1.5/src/commands/CGI/profiles/update.ts)_
<!-- commandsstop -->
